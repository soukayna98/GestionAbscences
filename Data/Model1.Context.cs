...
namespace GestionAbscences.Data
{
    ...
    public partial class GestionAbscencesEntities9 : DbContext
    {
        public GestionAbscencesEntities9()
            : base("name=GestionAbscencesEntities9")
        {
        }
        ...
        public virtual DbSet<dc_temp> dc_temp { get; set; }
